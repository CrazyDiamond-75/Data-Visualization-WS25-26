...
\begin{document}
    ...
    \begin{exercise}[Car Dataset with Altair] \hfill
        \begin{center}
            \includegraphics[width=0.6\textwidth]{mpg_hp_weight.pdf}
        \end{center}
        ...
        \begin{center}
            \includegraphics[width=0.6\textwidth]{mpg_origin_accel.pdf}
        \end{center}
        ...
        \begin{center}
            \includegraphics[width=0.6\textwidth]{encodings.pdf}
        \end{center}
