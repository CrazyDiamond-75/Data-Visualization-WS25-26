...
\begin{document}
    ...
    \begin{exercise}[Car Dataset with Altair]
        \begin{centering}
            \includegraphics[width=0.6\textwidth]{mpg_hp_weight.svg}
        \end{centering}
        ...
        \begin{centering}
            \includegraphics[width=0.6\textwidth]{mpg_origin_accel.svg}
        \end{centering}
        ...
        \begin{centering}
            \includegraphics[width=0.6\textwidth]{encodings.svg}
        \end{centering}
